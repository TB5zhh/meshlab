...
RichParameterList FilterColorProc::initParameterList(const QAction *a, const MeshDocument& md)
{
	...
	case CP_SELECT_TYPE:
	{
		...
		typeNameList.push_back("0"); 
		typeNameList.push_back("1"); 
		typeNameList.push_back("2"); 
		typeNameList.push_back("3"); 
		typeNameList.push_back("4"); 
		typeNameList.push_back("5"); 
		typeNameList.push_back("6"); 
		typeNameList.push_back("7"); 
		typeNameList.push_back("8"); 
		typeNameList.push_back("9"); 
		typeNameList.push_back("10");
		typeNameList.push_back("11");
		typeNameList.push_back("12");
		typeNameList.push_back("13");
		typeNameList.push_back("14");
		typeNameList.push_back("15");
		typeNameList.push_back("16");
		typeNameList.push_back("17");
		typeNameList.push_back("18");
		typeNameList.push_back("19");
		typeNameList.push_back("20");
		typeNameList.push_back("21");
		typeNameList.push_back("22");
		typeNameList.push_back("23");
		typeNameList.push_back("24");
		typeNameList.push_back("25");
		typeNameList.push_back("26");
		typeNameList.push_back("27");
		typeNameList.push_back("28");
		typeNameList.push_back("29");
		typeNameList.push_back("30");
		typeNameList.push_back("31");
		typeNameList.push_back("32");
		typeNameList.push_back("33");
		typeNameList.push_back("34");
		typeNameList.push_back("35");
		typeNameList.push_back("36");
		typeNameList.push_back("37");
		typeNameList.push_back("38");
		typeNameList.push_back("39");
		typeNameList.push_back("40");
		typeNameList.push_back("41");
		typeNameList.push_back("42");
		typeNameList.push_back("43");
		typeNameList.push_back("44");
		typeNameList.push_back("45");
		typeNameList.push_back("46");
		typeNameList.push_back("47");
		typeNameList.push_back("48");
		typeNameList.push_back("49");
		typeNameList.push_back("50");
		typeNameList.push_back("51");
		typeNameList.push_back("52");
		typeNameList.push_back("53");
		typeNameList.push_back("54");
		typeNameList.push_back("55");
		typeNameList.push_back("56");
		typeNameList.push_back("57");
		typeNameList.push_back("58");
		typeNameList.push_back("59");
		typeNameList.push_back("60");
		typeNameList.push_back("61");
		typeNameList.push_back("62");
		typeNameList.push_back("63");
		typeNameList.push_back("64");
		typeNameList.push_back("65");
		typeNameList.push_back("66");
		typeNameList.push_back("67");
		typeNameList.push_back("68");
		typeNameList.push_back("69");
		typeNameList.push_back("70");
...
std::map<std::string, QVariant> FilterColorProc::applyFilter(const QAction *filter, const RichParameterList &par, MeshDocument &md, unsigned int& /*postConditionMask*/, vcg::CallBackPos *cb)
{
	...
	switch(ID(filter))
	{
		...
		case CP_SELECT_TYPE:
		{
			...
			switch (scanType)
			{
				case  0 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(174, 199, 232, 113), true); break;
				case  1 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(152, 223, 138, 113), true); break;
				case  2 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(52, 223, 138, 128), true); break;
				case  3 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(31, 119, 180, 128), true); break;
				case  4 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 187, 120, 128), true); break;
				case  5 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(188, 189, 34, 128), true); break;
				case  6 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(140, 136, 75, 128), true); break;
				case  7 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 152, 150, 128), true); break;
				case  8 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(214, 39, 40, 128), true); break;
				case  9 : count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(197, 176, 213, 128), true); break;
				case  10: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(148, 103, 189, 128), true); break;
				case  11: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(196, 156, 148, 128), true); break;
				case  12: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(173, 90, 237, 128), true); break;
				case  13: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(23, 190, 207, 128), true); break;
				case  14: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(247, 182, 210, 128), true); break;
				case  15: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(66, 188, 102, 128), true); break;
				case  16: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(219, 219, 141, 128), true); break;
				case  17: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(140, 57, 197, 128), true); break;
				case  18: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(202, 185, 52, 128), true); break;
				case  19: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(51, 176, 203, 128), true); break;
				case  20: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(200, 54, 131, 128), true); break;
				case  21: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(92, 193, 61, 128), true); break;
				case  22: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(78, 71, 183, 128), true); break;
				case  23: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(172, 114, 82, 128), true); break;
				case  24: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 127, 14, 128), true); break;
				case  25: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(91, 163, 138, 128), true); break;
				case  26: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(153, 98, 156, 128), true); break;
				case  27: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(140, 153, 101, 128), true); break;
				case  28: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(158, 218, 229, 128), true); break;
				case  29: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(100, 125, 154, 128), true); break;
				case  30: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(178, 127, 135, 128), true); break;
				case  31: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(18, 167, 135, 128), true); break;
				case  32: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(146, 111, 194, 128), true); break;
				case  33: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(44, 160, 44, 128), true); break;
				case  34: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(112, 128, 144, 128), true); break;
				case  35: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(96, 207, 209, 128), true); break;
				case  36: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(227, 119, 194, 128), true); break;
				case  37: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(213, 92, 176, 128), true); break;
				case  38: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(94, 106, 211, 128), true); break;
				case  39: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(82, 84, 163, 128), true); break;
				case  40: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(100, 85, 144, 128), true); break;
				case  41: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(0, 61, 245, 128), true); break;
				case  42: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 219, 112, 128), true); break;
				case  43: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(112, 148, 254, 128), true); break;
				case  44: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(194, 71, 71, 128), true); break;
				case  45: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(224, 163, 163, 128), true); break;
				case  46: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(71, 133, 194, 128), true); break;
				case  47: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(194, 133, 71, 128), true); break;
				case  48: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(184, 41, 255, 128), true); break;
				case  49: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(112, 255, 41, 128), true); break;
				case  50: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 76, 41, 128), true); break;
				case  51: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(163, 240, 255, 128), true); break;
				case  52: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(51, 0, 152, 128), true); break;
				case  53: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(102, 153, 0, 128), true); break;
				case  54: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(51, 153, 153, 128), true); break;
				case  55: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(153, 51, 153, 128), true); break;
				case  56: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(82, 82, 255, 128), true); break;
				case  57: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 255, 71, 128), true); break;
				case  58: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(130, 20, 255, 128), true); break;
				case  59: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 0, 26, 128), true); break;
				case  60: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 102, 0, 128), true); break;
				case  61: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(194, 71, 133, 128), true); break;
				case  62: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(71, 194, 71, 128), true); break;
				case  63: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(92, 184, 0, 128), true); break;
				case  64: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(0, 0, 184, 128), true); break;
				case  65: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(184, 92, 0, 128), true); break;
				case  66: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(0, 184, 92, 128), true); break;
				case  67: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(184, 0, 0, 128), true); break;
				case  68: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(51, 255, 255, 128), true); break;
				case  69: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 51, 153, 128), true); break;
				case  70: count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(0, 138, 184, 128), true); break;
				default: assert(0);
			}
