	...
	switch(ID(filter))
	{
		...
		case CP_SELECT_TYPE:
		{
			...
			switch (scanType)
			{
				...
				case  2:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(31, 119, 180, 113), true); break;
				case  3:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 187, 120, 113), true); break;
				case  4:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(188, 189, 34, 113), true); break;
				case  5:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(140, 86, 75, 113), true); break;
				case  6:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 152, 150, 113), true); break;
				case  7:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(214, 39, 40, 113), true); break;
				case  8:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(197, 176, 213, 113), true); break;
				case  9:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(148, 103, 189, 113), true); break;
				case 10:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(196, 156, 148, 113), true); break;
				case 11:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(23, 190, 207, 113), true); break;
				case 12:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(124, 232, 109, 113), true); break;
				case 13:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(247, 182, 210, 113), true); break;
				case 14:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(66, 188, 102, 113), true); break;
				case 15:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(219, 219, 141, 113), true); break;
				case 16:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(140, 57, 197, 113), true); break;
				case 17:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(202, 185, 52, 113), true); break;
				case 18:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(51, 176, 203, 113), true); break;
				case 19:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(200, 54, 131, 113), true); break;
				case 20:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(92, 193, 61, 113), true); break;
				case 21:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(78, 71, 183, 113), true); break;
				case 22:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(172, 114, 82, 113), true); break;
				case 23:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(255, 127, 14, 113), true); break;
				case 24:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(91, 163, 138, 113), true); break;
				case 25:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(153, 98, 156, 113), true); break;
				case 26:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(140, 153, 101, 113), true); break;
				case 27:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(158, 218, 229, 113), true); break;
				case 28:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(100, 125, 154, 113), true); break;
				case 29:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(178, 127, 135, 113), true); break;
				case 30:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(56, 23, 31, 113), true); break;
				case 31:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(146, 111, 194, 113), true); break;
				case 32:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(44, 160, 44, 113), true); break;
				case 33:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(112, 128, 144, 113), true); break;
				case 34:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(96, 207, 209, 113), true); break;
				case 35:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(227, 119, 194, 113), true); break;
				case 36:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(213, 92, 176, 113), true); break;
				case 37:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(94, 106, 211, 113), true); break;
				case 38:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(82, 84, 163, 113), true); break;
				case 39:count = vcg::tri::UpdateColor<CMeshO>::PerVertexConstant(m->cm, Color4b(100, 85, 144, 113), true); break;
				default: assert(0);
			}
